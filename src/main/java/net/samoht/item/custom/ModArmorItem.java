...
public class ModArmorItem extends Item {
    private static final Map<ArmorMaterial, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<@NotNull ArmorMaterial, @NotNull List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.ARGENTIUM_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.HASTE, 500, 1, false, false)))
                    .build();
